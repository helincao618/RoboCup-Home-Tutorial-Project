...
namespace from2Dto3DSpace
{
  ...
  {   
    ...
    handle_x = 1;
    handle_y = 2;
    handle_3d.x = pCloud.at(handle_x,handle_y).x;
    handle_3d.y = pCloud.at(handle_x,handle_y).y;
    handle_3d.z = pCloud.at(handle_x,handle_y).z;
