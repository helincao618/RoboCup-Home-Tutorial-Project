...
namespace transformSpace
{
    ...
    /*************************************************************************************************************/
 	...
 	/*************************************************************************************************************/
        ...
        //cout << "The determinant of transform_1 is " << transform_1.determinant() << endl;
    ...
    void Transform::transformtoBaselink ()
    {
        ...
        if((!isnan(coordinate_normal_g.z))&&(!isnan(coordinate_handle_g.z)))
        {
            ...
            ROS_INFO("------------------------------------");
            //ROS_INFO("The normal vector according to base_link is: ");
            //ROS_INFO_STREAM(coordinate_normal_base_g.x);
            //ROS_INFO_STREAM(coordinate_normal_base_g.y);
            //ROS_INFO_STREAM(coordinate_normal_base_g.z);
            //ROS_INFO_STREAM(coordinate_handle_base_g.x);
            //ROS_INFO_STREAM(coordinate_handle_base_g.y);
            //ROS_INFO_STREAM(coordinate_handle_base_g.z);
        }
