...
namespace turtleSpace
{
	...
	Vector2d turtlePose_desired_g;	
//#>>>>TODO:CREATE A CALLBACK FUNCTION FOR THE TOPIC turtle_vis::DesiredPose (SEE TurtleClass.cpp)
			
	void getPose(const nav_msgs::Odometry::ConstPtr &msg);			//#>>>>TODO:CREATE A CALLBACK FUNCTION FOR THE SERVICE turtle_vis::send_desired_pose
