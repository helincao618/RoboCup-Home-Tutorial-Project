...
if("TRUE" STREQUAL "TRUE")
  set(turtle_vis_SOURCE_PREFIX /home/caohelin/ros/workspaces/roboCupHome_tutorial_HELINCAO/src/turtle_vis)
  set(turtle_vis_DEVEL_PREFIX /home/caohelin/ros/workspaces/roboCupHome_tutorial_HELINCAO/src/turtle_vis-build/devel)
...
if(NOT "/home/caohelin/ros/workspaces/roboCupHome_tutorial_HELINCAO/src/turtle_vis-build/devel/include;/home/caohelin/ros/workspaces/roboCupHome_tutorial_HELINCAO/src/turtle_vis/include " STREQUAL " ")
  set(turtle_vis_INCLUDE_DIRS "")
  set(_include_dirs "/home/caohelin/ros/workspaces/roboCupHome_tutorial_HELINCAO/src/turtle_vis-build/devel/include;/home/caohelin/ros/workspaces/roboCupHome_tutorial_HELINCAO/src/turtle_vis/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtle_vis' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/caohelin/ros/workspaces/roboCupHome_tutorial_HELINCAO/src/turtle_vis/${idir}'.  ${_report}")
    endif()
    _list_append_unique(turtle_vis_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/x86_64-linux-gnu/libconsole_bridge.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/caohelin/ros/workspaces/roboCupHome_tutorial_HELINCAO/src/turtle_vis-build/devel/lib;/opt/ros/kinetic/lib)
