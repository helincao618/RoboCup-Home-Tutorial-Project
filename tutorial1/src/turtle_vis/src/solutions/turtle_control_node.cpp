...
int main( int argc, char** argv )
{
    ...
    //ADVERTIZE THE TOPIC
    ros::Publisher pub=n.advertise<turtle_vis::DesiredPose>("turtle_control",100);/*#>>>>TODO: DEFINE THE MSG TYPE*/
    ...
    ros::param::get("p_gain",p_g);/*/#>>>>TODO: DEFINE PARAMETER*/
  ...
  
    {
        ...
        turtlePose_desired_local=turtleF.turtlePose_desired_g;//CALL_THE_METHOD_TO_OBTAIN_THE_DESIRED_POSE();
